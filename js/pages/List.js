            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <template v-if="editors">
                        ...
                        <p>Have either source audio or clicks or taps in the video (edited audio does not count like clickbots or post edit clicks)</p>
                        ...
                        <p>If your level was submitted into the QCL over a week after verifying, it will not be accepted unless exempted by staff.</p>

                        <p>CPS will be limited to be 10 cps or under for verifications with no exceptions.</p>

                        <p>All these rules may be subject to change in the future. Levels or completions which previously followed rules before change that may violate newer rules will be exempted.</p>
                </div>
            </div>
        </main>
    `,
